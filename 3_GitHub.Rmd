...
If you choose to generate a personal access token with an expiration date, you'll need to generate a new personal access token whenever your old token expires. When you have a new personal access token, you can set that token in RStudio using the library `gitcreds`. When you run the function `gitcreds_set()`, you will be given the option to replace your GitHub security credentials. Select this option (option 2) then paste in the new personal access token. All done!
...
This is especially relevant for our class, because **I have created tutorials and code for each of the class modules and hosted them in repositories on GitHub:** <https://github.com/MSCI-709-2025>
...
Go to the course GitHub page <https://github.com/MSCI-709-2025> and Fork the first module `unit_1_getting_started` to your own GitHub profile:

-  Go to the course GitHub page <https://github.com/MSCI-709-2025>
